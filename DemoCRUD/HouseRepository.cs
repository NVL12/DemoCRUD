    ...
    public class HouseRepository : IHouseRepository
    {
        ...
        public void AddHouse(House house)
        {
            using(IDbConnection cnn = Connection)
            {
                ...
                cnn.Execute(query, new { phone = house.Phone, name = house.Name,
                    address = house.Address, type = house.Type, description = house.Description,
                    price = house.Price, acreage = house.Acreage, caption = house.Caption });
                cnn.Close();
        ...
        public House GetHouseById(int id)
        {
            using (IDbConnection cnn = Connection)
            {
                ...
                cnn.Open();
                return cnn.Query<House>(query, new { id = id }).SingleOrDefault();
            }
        }
